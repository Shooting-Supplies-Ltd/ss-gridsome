  ...
  <Layout>
    ...
    <div class="page-description w-full mt-8 p-20 bg-gray-100">
      <div class="mx-24 my-8">
        <h1 class="font-bold text-2xl">Red Dot Sights</h1>
        <p class="mt-4">
          We carry a range of Red Dot Sights & Optics from all of the major
          manufacturers.
        </p>
        <p class="mt-2">
...
query products ($page: Int) {
  allWooProducts(perPage: 12, page: $page, filter: { status: { eq: "publish" }, categories: {id: {eq: 4681}} }, sortBy: "name", order: ASC) @paginate {
    pageInfo {
    totalPages
    currentPage
}
