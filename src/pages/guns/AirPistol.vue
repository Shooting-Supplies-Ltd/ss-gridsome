  ...
  <Layout>
    ...
    <div class="page-description w-full mt-8 p-20 bg-gray-100">
      <div class="mx-24 my-8">
        <h1 class="font-bold text-2xl">AIR PISTOLS</h1>
        <p class="mt-4">We carry a comprehensive range of both new & used air pistols from all of the major manufacturers.</p>
...
<page-query>
query ($page: Int) {
  allGuns(perPage: 12, page: $page, sortBy: "title", order: ASC, filter: {type: {in: ["Air Pistol"]}}) @paginate {
    pageInfo {
      totalPages
      currentPage
    }
