<template>
  <Layout>
    ...
    <div class="flex items-start">
      ...
      <div class="flex justify-center flex-wrap mx-4 mt-8 h-auto lg:w-full lg:mt-32">
        <div
    ...
    <div class="page-description w-full mt-8 p-20 bg-gray-100">
      <div class="mx-24 my-8">
        <h1 class="font-bold text-2xl">TIPPMANN ARMS M4 .22 RIFLES</h1>
        <p class="mt-4">As the UK distributor, we carry a range of both new & used Tippmann Arms M4 .22LR Semi Automatic Rifles.</p>
...
export default {
  metaInfo() {
    return {
      title: "Tippmann Arms M4 22 Rifles"
    };
  },
  data() {
    return {
...
query products ($page: Int) {
  allWooProducts(perPage: 12, page: $page, filter: { status: { eq: "publish" }, id: {in: [18952, 18951, 18950, 18949, 27461]}}, sortBy: "name", order: ASC) @paginate {
    pageInfo {
    totalPages
    currentPage
}
