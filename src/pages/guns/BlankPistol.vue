  ...
  <Layout>
    ...
    <div class="page-description w-full mt-8 p-20 bg-gray-100">
      <div class="mx-24 my-8">
        <h1 class="font-bold text-2xl">BLANK PISTOLS</h1>
        <p class="mt-4">We carry a range of both new & used Blank Pistols from all of the major manufacturers.</p>
...
<page-query>
query ($page: Int) {
  allGuns(perPage: 12, page: $page, sortBy: "title", order: ASC, filter: {type: {in: ["Pistol (Blanks)"]}}) @paginate {
    pageInfo {
      totalPages
      currentPage
    }
