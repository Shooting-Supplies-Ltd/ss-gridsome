  ...
  <div class="flex items-center justify-center">
    <div class="w-full">
      <input
        id="search"
        v-model="searchTerm"
        class="w-3/4 flex justify-center rounded-lg mt-8 mb-4 p-2 shadow-inner focus:rounded-lg focus:shadow-outline text-black mx-auto"
        type="text"
      ...
      <div id="results" class="w-full flex flex-wrap justify-center">
        <div
          ...
          :key="result.id"
          class="flex justify-center rounded-lg m-4 p-2 shadow focus:rounded-lg focus:shadow-outline focus:border-ssblue text-white border-2 font-semibold sm:w-1/3"
        >
