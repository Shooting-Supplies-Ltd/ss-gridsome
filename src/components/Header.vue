          ...
          <div id="contact" class="flex items-center">
            <p class="mr-8">
              <a href="tel:01527831261">
                <span class="hover:text-ssorange">Call Us: 0152783126
                  <svg 
                    aria-hidden="true" 
                    focusable="false" 
                    data-prefix="fas" 
                    data-icon="phone" 
                    class="svg-inline--fa fa-phone fa-w-16 ml-2" 
            ...
            <p>
              <a href="mailto:info@shootingsuppliesltd.co.uk">
                <span class="hover:text-ssorange">Email Us: 
                  <svg 
                    aria-hidden="true" 
                    focusable="false" 
                    data-prefix="fas" 
                    data-icon="envelope" 
                    class="svg-inline--fa fa-envelope fa-w-16 ml-2" 
                    role="img" xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 512 512">
