    ...
    <header class="w-full shadow-lg border-t-4 mb-8 rounded-t border-ssblue">
        ...
        <div class="container w-1/2 flex flex-initial justify-center items-center text-white">
          <div id="contact" class="flex items-center">
            <p class="mr-4"><a href="tel:01527831261"><span class="hover:text-ssorange">Call Us: 0152783126<font-awesome :icon="['fas', 'phone']" class="ml-2"/></span></a></p>
        ...
        <div class="container w-1/2 flex flex-initial justify-center items-center text-white">
          <div id="social" class="flex items-center">
            ...
            <p class="text-xl mr-4"><a href="https://www.facebook.com/ShootingSuppliesLTD/" target="_blank"><font-awesome :icon="['fab', 'facebook-square']" class="hover:text-ssorange" /></a></p>
            <p class="text-xl mr-4"><a href="https://twitter.com/shootingsupplys" target="_blank"><font-awesome :icon="['fab', 'twitter']" class="hover:text-ssorange" /></a></p>
            <p class="text-xl"><a href="https://www.instagram.com/shootingsupplies/" target="_blank"><font-awesome :icon="['fab', 'instagram']" class="hover:text-ssorange" /></a></p>
          </div>
        </div>
